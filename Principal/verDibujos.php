        ...
        <div class="wrapper">
            ...
            <div id="cuerpo">
                ...
                <?php
                    ...
                    $id = $_SESSION["id"];
                    $sql = "SELECT * FROM dibujo WHERE id_usuario = $id AND activo = 1 ORDER BY fecha";
                    ...
                    if(!$query) {
                        ...
                        if($rowcount > 0) {
                            ...
                            while($dibujo = mysqli_fetch_array($query)) {
                                ...
                                Descargar</a>";
                                echo "<input type='submit' id='$id_dibujo' name='$id_dibujo' value='Modificar Datos' 
                                ...
                                onmouseenter='cambiarOcultoDos(this.name); 
                                    cambiarOculto(document.getElementById(\"" . $id_dibujo . "\").name);' 
                                    class='boton' /> <br><br>";
                                $i++;
